...
class JSONRPC_ServiceWizard(JSONRPCBase):
    def __init__(self):
        ...
        self.modules = {
            ...
            "kb_Metrics": {"url": "http://localhost:5001"},
        }
