...
class JobBrowserBFF:
    ...
    def get_jobs(self, ctx, params):
        ...
        jobs = model.get_jobs(params['job_ids'], params.get('admin', False))
    ...
    def query_jobs(self, ctx, params):
        ...
        :param params: instance of type "QueryJobsParams" (TODO: expand to
           ...
           -> structure: parameter "workspace_id" of Long, parameter "status"
           of String, parameter "terminated_code" of Long, parameter
           "error_code" of Long, parameter "time_span" of type "TimeSpanSpec"
           -> structure: parameter "from" of type "epoch_time", parameter
           "to" of type "epoch_time", parameter "client_groups" of list of
           type "ClientGroup" (njs, bigmem, bigmemlong, kb_import, ...),
           parameter "offset" of Long, parameter "limit" of Long, parameter
           "admin" of type "bool" (Type synonym conveniences)
